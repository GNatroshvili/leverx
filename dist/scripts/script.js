...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const emptyEmployeesWrapper = document.querySelector(".empty-employees-wrapper");
    ...
    const advancedBuildingInput = document.getElementById("advanced-building-input");
    const advancedRoomInput = document.getElementById("advanced-room-input");
    const advancedDepartmentInput = document.getElementById("advanced-department-input");
    const advancedSearchSubmitBtn = document.getElementById("advanced-search-submit-btn");
    ...
    function showGridView() {
        currentView = "grid";
        const dataToShow = filteredEmployees.length > 0 ? filteredEmployees : employeesData;
    ...
    function searchAdvancedEmployees() {
        ...
        filteredEmployees = employeesData.filter((emp) => {
            ...
            const departmentMatch = !departmentQuery || department === departmentQuery;
            return (nameMatch &&
                emailMatch &&
                phoneMatch &&
                skypeMatch &&
