                ...
                <div className="data-line-wrapper">
                  ...
                  <div className="data-title-value-wrapper">
                    {isEditMode ? (
                      ...
                      <p id="details-building">
                        {currentEmployee.building || "N/A"}
                      </p>
                    )}
                  </div>
                </div>
                  ...
                  <div className="data-title-value-wrapper">
                    {isEditMode ? (
                      <input
                        ...
                        onChange={(e) =>
                          handleInputChange("skype", e.target.value)
                        }
                  ...
                  <div className="data-title-value-wrapper">
                    {isEditMode ? (
                      <input
                        ...
                        onChange={(e) =>
                          handleInputChange("cnumber", e.target.value)
                        }
                        placeholder="Enter C-number"
                        className="edit-input"
                      />
                    ) : (
                      <p id="details-cnumber">
                        {currentEmployee.cnumber || "N/A"}
                      </p>
                    )}
                  </div>
                </div>
            ...
            <div className="employee-travel-info-wrapper">
              ...
              <div className="data-column">
                <div className="data-line-wrapper">
                  <div className="data-title-wrapper">
                    <img
                      src="/assets/citizienship.png"
                      alt="citizienship-icon"
                      className="icon-size"
                    />
                ...
                {currentEmployee.visa_1 && (
                  <>
                    <div className="data-line-wrapper">
                      ...
                      <div className="data-title-value-wrapper">
                        <p id="details-visa-1">
                          {currentEmployee.visa_1 || "N/A"}
                        </p>
                      </div>
                    </div>

                    {currentEmployee.visa_1_start_date &&
                      currentEmployee.visa_1_end_date && (
                        <div className="data-line-wrapper">
                          <div className="data-title-wrapper">
                            <img
                              src="/assets/date-of-birth.png"
                          ...
                          <div className="data-title-value-wrapper">
                            <p id="details-visa-1-period">
                              {formatDate(currentEmployee.visa_1_start_date)} -{" "}
                              {formatDate(currentEmployee.visa_1_end_date)}
                              {isVisaExpired(currentEmployee.visa_1_end_date) &&
                                " (expired)"}
                            </p>
                          </div>
                        </div>
                ...
                {currentEmployee.visa_2 && (
                  <>
                    <div className="data-line-wrapper">
                      ...
                      <div className="data-title-value-wrapper">
                        <p id="details-visa-2">
                          {currentEmployee.visa_2 || "N/A"}
                        </p>
                      </div>
                    </div>

                    {currentEmployee.visa_2_start_date &&
                      currentEmployee.visa_2_end_date && (
                        <div className="data-line-wrapper">
                          <div className="data-title-wrapper">
                            <img
                              src="/assets/date-of-birth.png"
                          ...
                          <div className="data-title-value-wrapper">
                            <p id="details-visa-2-period">
                              {formatDate(currentEmployee.visa_2_start_date)} -{" "}
                              {formatDate(currentEmployee.visa_2_end_date)}
                              {isVisaExpired(currentEmployee.visa_2_end_date) &&
                                " (expired)"}
                            </p>
                          </div>
                        </div>
